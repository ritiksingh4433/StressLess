import { Activity, User, ArrowLeft, Home, Github } from 'lucide-react';
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <nav className="flex items-center gap-6">
            <button
              ...
              className="text-slate-500 dark:text-slate-400 hover:text-yellow-500 transition-colors text-sm font-bold cursor-pointer bg-none border-none"
            >
              Privacy
            </button>
            <button
